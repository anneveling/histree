...
//  var json = {
//    id : "root", name:"history", children: [
//      { id: "1" , name: "1", children: [ { id: "1_1" , name: "1_1"}, { id: "1_2" , name: "1_2" }, { id: "1_3" , name: "1_3" } ] },
//      { id: "2" , name: "2", children: [ { id: "2_1" , name: "2_1"}, { id: "2_2" , name: "2_2" }, { id: "2_3" , name: "2_3" } ] }
//    ]
//  };
    //end
    ...
    var st = new $jit.ST({
        ...
        onCreateLabel: function(label, node){
            label.id = node.id;            
            label.innerHTML = node.name; // '<a target="_blank" href="http://google.com?q='+node.name+'">'+node.name+'</a>';
